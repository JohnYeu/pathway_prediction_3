...
\usepackage{microtype,setspace,lineno}
\usepackage{authblk}
...
\title{\textbf{Machine Learning-Based Scoring of Pathway-Like Gene Modules
in \textit{Arabidopsis thaliana} Using Gene Ontology Annotation Features
and SHAP Interpretability}}

\author[1]{Yuzhuo Ye}
\affil[1]{Computational Biology and Plant Bioinformatics}
\date{\small \today}
\maketitle
\thispagestyle{empty}
...
\subsection{Biological pathways, gene modules, and pathway-like coherence}
...
\subsection{Curated pathway resources and the incompleteness of pathway catalogues}
...
\subsection{From enrichment analysis to internal coherence scoring}
...
\subsection{Gene modules in plant transcriptomics and stress-response studies}
...
\subsection{Rationale for a GO-based, graph-free machine-learning approach}
...
\subsection{Negative examples and benchmark design}
...
\subsection{Gene Ontology and functional representation}
\label{sec:lit_go}
...
\subsection{Pathway enrichment, pathway activity, and gene-set interpretation}
...
\subsection{Co-expression modules and network-based function inference}
...
\subsection{Machine learning for tabular biological data}
...
\subsection{Explainability and biological interpretation}
\label{sec:lit_xai}
...
\subsection{Foundation models, multi-omics representations, and future directions}
...
\subsection{Evaluation metrics, class imbalance, and benchmark interpretation}
...
\subsection{Reproducibility, data provenance, and version control}
...
\subsection{Positioning of PathwayML-Ath}
...
\subsection{Pathway interpretation as a modelling problem}
...
\subsection{Practical problem: interpreting gene lists that are not pathway entries}
...
\subsection{Why GO annotations are suitable but imperfect}
...
\subsection{Why negative examples require explicit design}
...
\subsection{GO-based functional representation beyond enrichment}
...
\subsection{Enrichment analysis and pathway activity methods}
...
\subsection{Co-expression networks and functional module discovery}
...
\subsection{Network-based function prediction and graph learning}
...
\subsection{Machine learning on tabular biological features}
...
\subsection{Explainability as a requirement for biological use}
...
\subsection{Synthesis of the literature and the project gap}
...
\subsection{Systematic comparison of machine learning methods and ORA context}
...
\subsection{Machine-learning models: decision trees, ensembles, and boosting}
...
\subsection{Model interpretation with Shapley values and SHAP}
...
\subsection{Evaluation metrics and the confusion matrix}
...
\subsection{Rationale for the feature-selection workflow}
...
\subsection{Rationale for Jaccard statistics as coherence features}
...
\subsection{Model-selection rationale and computational constraints}
...
\subsection{Held-out model comparison}
...
\subsection{Leave-one-family-out (LOFO) validation}
\label{sec:res_lofo}
...
\subsection{Understanding the performance level}
...
\subsection{LOFO family variation}
...
\subsection{Interpreting SHAP features and broad GO terms}
...
\subsection{Relationship to enrichment analysis}
...
\subsection{Implications for plant functional genomics}
...
\section{Appendix A: Terminology Guide}
